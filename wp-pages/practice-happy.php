...
<div class="container coreplus-practice-happy-landing-page">
      <div class="row">
        <div class="col-md-6">
          <div class="coreplus-ph-hero-text">
            ...
            <p>
              Where our customers come together to connect, learn, and share
              with other allied healthcare professionals.
            </p>
          </div>
        </div>
        <div class="col-md-6 cp-lp-hero-image">
          <img src="<?php get_template_directory_uri(). '/practicehappy/images/practice-happy-hero-image.svg' ?>" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="container ph-logo-line">
      <div class="row">
        ...
        <div class="col-md-4 ph-logo">
          <img src="<?php get_template_directory_uri().'/practicehappy/images/practice-happy-logo.png'?>" alt="" />
        </div>
        <div class="col-md-4"><hr class="ph-line ph-hide-in-small" /></div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6 phc-text-div">
          ...
          <div class="phc-button">
            <a href="https://practicehappy.coreplus.com.au/"
              >Practice Happy Community</a
            >
          </div>
        </div>
        <div class="col-md-6 phc-image">
          <img src="<?php get_template_directory_uri().'/practicehappy/images/practice-happy-mockup.png'?>" alt="" />
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <h1 class="phb-title">
          What are the benefits of being a Practice <br />
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="ph-benefits">
            <img src="<?php get_template_directory_uri().'/practicehappy/images/ph-connect.svg'?>" alt="" />
        ...
        <div class="col-md-4">
          <div class="ph-benefits">
            <img src="<?php get_template_directory_uri().'/practicehappy/images/learn-together.svg'?>" alt="" />
        ...
        <div class="col-md-4">
          <div class="ph-benefits">
            <img src="<?php get_template_directory_uri().'/practicehappy/images/grow-together.svg'?>" alt="" />
            <h4>Grow Together</h4>
            <p>
